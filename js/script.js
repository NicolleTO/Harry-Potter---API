    ...
    result.forEach((character) => {
        ...
        function houseHogwarts(house){
            if(house.toLowerCase() == "hufflepuff"){
                document.getElementById('house').src = "images/Hufflepuff.png"

            }else if(house.toLowerCase() == "gryffindor"){
                document.getElementById('house').src = "images/Gryffindor.png"

            }else if(house.toLowerCase() == "ravenclaw"){
                document.getElementById('house').src =  "images/Ravenclaw.png"

            }else if(house.toLowerCase() == "slytherin"){
                document.getElementById('house').src = "images/Slytherin.png"
